...
1. Limiti di Azione (Sandbox Logica)

L'agente deve operare esclusivamente all'interno della cartella radice AgentMenager Google.

È severamente vietato leggere, modificare o eliminare file al di fuori di questo percorso.

Non devono essere mai utilizzati percorsi assoluti (es. C:\Users\... o /Users/...). Utilizza sempre percorsi relativi alla cartella del progetto.

2. Verifica e Trasparenza

Prima di eseguire uno script che comporta lo spostamento o l'eliminazione di file, l'agente deve riassumere brevemente l'operazione pianificata.

Al termine di ogni ciclo di elaborazione (es. dopo aver processato un gruppo di PDF), l'agente deve fornire un breve "Rapporto di Stato" in chat, indicando:

Numero di file processati con successo.

Eventuali errori riscontrati.

Posizione dei nuovi file creati.

3. Gestione Errori

Se lo script tenta di accedere a una directory non autorizzata, l'esecuzione deve essere interrotta immediatamente e l'utente deve essere avvisato.